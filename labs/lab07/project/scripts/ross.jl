...
println("Ross model baseline experiment completed")
println("  mean crash time: ", round(summary.mean_crash_time[1], digits = 4))
println("  analytic crash time: ", round(summary.analytic_crash_time[1], digits = 4))
