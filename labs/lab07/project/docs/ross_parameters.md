...
Сценарий сравнивает время до падения системы, среднюю длину очереди на ремонт
и загрузку ремонтников при разных значениях числа рабочих машин, резервов и
ремонтников.
