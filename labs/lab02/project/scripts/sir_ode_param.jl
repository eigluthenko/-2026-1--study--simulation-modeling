# # Модель SIR: Параметрическое исследование
# **Цель:** Исследовать влияние параметров на динамику эпидемии SIR.
#
...
# Исследуем влияние вероятности заражения $\beta$ на динамику эпидемии.
...
# ## График пикового числа заражённых
